...
#define _C843_H_
#ifdef _DUMPING
#pragma message("STATIC_MC_LIB-")
#endif
#if !defined(STATIC_MC_LIB)
	#ifdef __cplusplus
		extern "C" {
	#endif
...
#else
	#define FUNC_DECL
	void SetHModule(HANDLE hModule);
	#pragma message("___________LIB___________________________________")
#endif

#include "../PMDController/PMDcmd.h"
#include "../shared/JKa/stdpi.h"
#ifdef WIN32
#include "Public.h"
#endif
...
//
// RETURNS: TRUE if board is present
//************************************************************

BOOL FUNC_DECL Select_Board(BYTE boradnumber);
HRESULT FUNC_DECL Select_PCIBoard(BYTE boradnumber);

int FUNC_DECL GetBoardRevision(BYTE boardnumber);
//************************************************************
...
//************************************************************
HRESULT FUNC_DECL Axis_Installed(BYTE* pnumber);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL GetNumberOfInstalledBoards(BYTE* pnumber);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL InitBoard(void);
...
//************************************************************
HRESULT FUNC_DECL InitAxis(BYTE axis);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL setQMC(BYTE bCmd,
						 BYTE bAxis, 
						 LONG Param);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL getQMC(BYTE bCmd, 
						 BYTE bAxis,
						 LONG* pResult);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL setQMCA(BYTE bCmd,
						  BYTE bAxis,
						  WORD Param1, 
						  LONG lParam2);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL getQMCA(BYTE bCmd,
						  BYTE bAxis,
						  WORD lParam,
						  LONG* pResult);
...
// Select_Board is included in Set/Get QMC to avoid race conditions
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL setQMC_SelBoard(pi_uint8 bCmd,
						 pi_uint8 bAxis, 
						 pi_int32 Param,pi_uint8 bBoard);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL getQMC_SelBoard(pi_uint8 bCmd, 
						 pi_uint8 bAxis,
						 pi_int32* pResult,pi_uint8 bBoard);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL setQMCA_SelBoard(pi_uint8 bCmd,
						  pi_uint8 bAxis,
						  pi_uint16 Param1, 
						  pi_int32 lParam2,pi_uint8 bBoard);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL getQMCA_SelBoard(pi_uint8 bCmd,
						  pi_uint8 bAxis,
						  pi_uint16 lParam,
						  pi_int32* pResult,pi_uint8 bBoard);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL translate(const char* szQFL, char* szReport);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL General_Command_Parser(const char *command, char *report);

//************************************************************
// FUNCTION:	translate_error(HRESULT error_code, char* report);
//
...
//
//************************************************************
void FUNC_DECL translate_error(HRESULT error_code, char* report);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL execute(BYTE bAxis, TCMD cmd, long arg, char* report);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL execute2(BYTE bAxis, TCMD cmd, long arg1, long arg2, char* report);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL Init_LS(BYTE axis1, BYTE axis2, BYTE axis3, BYTE axis4);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL autodetect(BYTE axis);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL set_pos(BYTE axis, long position);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL WaitStop(BYTE axis);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_pos(BYTE axis, long* ppos);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_PosErr(BYTE axis, long* perror_count);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_pos4(long Pos[4]);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_v(BYTE axis, long* pvel);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_activity_status(BYTE axis, WORD* preg_val);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_event_status(BYTE axis, WORD* preg_val);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_signal_status(BYTE axis, WORD* preg_val);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL get_RefSignal(BYTE axis, BOOL *pref_value);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveA(BYTE axis, long position);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveA_12(long position1, long position2);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveA_123(long position1, long position2, long position3);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveR(BYTE axis, long position);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveR_12(long position1, long position2);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL MoveR_123(long position1, long position2, long position3);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL VectorA(BYTE axis1, BYTE axis2, 
                   long position1, long position2, long vel);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL VectorR(BYTE axis1, BYTE axis2, 
                   long position1, long position2, long vel);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL AutoFindEdge(BYTE axis);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL Recover(BYTE axis, long vel);
...
// RETURNS: error code or S_OK
//************************************************************
HRESULT FUNC_DECL Get_Version(long* ver);
...
//************************************************************
#ifdef WIN32
HRESULT FUNC_DECL InitMessaging(unsigned int reg_mask);
HRESULT FUNC_DECL RegisterMessage(HWND hwndWindow, DWORD MessageID, DWORD reason, int AxisNo = 0);
HRESULT FUNC_DECL UnRegisterMessage(HWND hwndWindow);
HRESULT FUNC_DECL waitForInt(ULONG* pResult);
HRESULT FUNC_DECL setupAndWaitForInt(ULONG* pResult, int iTimeoutMs = 2000, HANDLE hCancelEvent = NULL);
HRESULT FUNC_DECL setupInt(USHORT iAxis, USHORT iMask);
HRESULT FUNC_DECL waitForIntResult(ULONG* pResult, int iTimeoutMs = 2000, HANDLE hCancelEvent = NULL);
HRESULT FUNC_DECL cancelWaitForInt();
#endif
HRESULT FUNC_DECL GetAvailablePCIBoards(char* szBoardIDs, int iMaxLen);
#ifdef WIN32
